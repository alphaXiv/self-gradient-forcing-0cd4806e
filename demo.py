"""
Interactive demo for Self Gradient Forcing.
"""
...
parser.add_argument("--checkpoint_path", type=str, default='checkpoints/framewise/ar_diffusion.pt')
parser.add_argument("--config_path", type=str, default='configs/self_gradient_forcing_framewise.yaml')
